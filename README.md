...
| **SierpinskiTriangle.java** | Ett program som ritar upp en sierpinskitriangel: ett fraktalmönster som ritar upp en triangel och för varje rekursivt anrop delar in den i tre mindre trianglar. |
