...
| **SierpinskiTriangle.java** | Ett program som ritar upp en sierpinskitriangel: ett fraktalmönster som ritar upp en triangel och för varje rekursivt anrop sedan delar in den i tre mindre trianglar. Använd +/- för att zooma och c för att slå på/av färg. |
